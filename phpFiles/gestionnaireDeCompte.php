...
<div id="managementFlex">
    ...
    <aside id="sideBarUser">
        <button class="sideBarButton" onclick="window.location='gestionnaireDeCompte.php'">
            account management
        </button>
        ...
        <button class="sideBarButton" onclick="window.location='resultatsAdmin.php'">
            results
        </button>

        <button class="sideBarButton" onclick="window.location='lotteryMaking.php'">
            lottery making
        </button>

        <button class="sideBarButton" onclick="window.location='logout.php'">
            logout
        </button>
    </aside>
        ...
        <?php else: ?>
            ...
            <?php while ($user = $result->fetch_assoc()): ?>
                ...
                <div class="request" style="border-left: 4px solid 
                    ...
                    <h2 class="nameOfAccount">
                        <?= htmlspecialchars($user["nom_prenom"]) ?>
                    </h2>
